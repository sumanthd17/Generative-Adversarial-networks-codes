...
def discriminator(X_image, reuse=False):
    ...
    d2 = d2 = tf.nn.avg_pool(d2, ksize=[1,2,2,1], strides=[1,2,2,1], padding='SAME')
...
def generator(batch_size, z_dim):
    ...
    # final conv with one output channel
...
for i in range(50000):
    ...
    if dLossReal > 0.45:
        # if the discriminator clssifies real images as fake, train the discriminator on realimages
